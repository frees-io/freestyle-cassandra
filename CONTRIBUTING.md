...
Discussion around freestyle-cassandra happens in the [Gitter channel](https://gitter.im/47deg/freestyle-cassandra) as well as on
[GitHub issues](https://github.com/47deg/freestyle-cassandra/issues) and [pull requests](https://github.com/47deg/freestyle-cassandra/pulls).

Feel free to open an issue if you notice a bug, have an idea for a feature, or have a question about
the code. Pull requests are also welcome.

People are expected to follow the [Typelevel Code of Conduct](http://typelevel.org/conduct.html) when discussing freestyle-cassandra on the Github page, Gitter channel, or other venues.
...
freestyle-cassandra follows a standard [fork and pull](https://help.github.com/articles/using-pull-requests/) model for contributions via GitHub pull requests.
