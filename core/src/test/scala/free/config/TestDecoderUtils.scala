...
import freestyle.free.cassandra.config.ClusterConfig._
...
class TestDecoderUtils extends WordSpec with MatchersUtil with Checkers with MockFactory {
  ...
  val executorClass = "freestyle.free.cassandra.config.MyJavaExecutor"
  ...
  val validClusterConfiguration: ClusterBuilderConfig = ClusterBuilderConfig(
    ...
    enableSSL = true.some,
    addressTranslator = "freestyle.free.cassandra.config.MyAddressTranslator".some,
    authProvider = "freestyle.free.cassandra.config.MyAuthProvider".some,
    loadBalancingPolicy = "freestyle.free.cassandra.config.MyLoadBalancingPolicy".some,
    reconnectionPolicy = "freestyle.free.cassandra.config.MyReconnectionPolicy".some,
    retryPolicy = "freestyle.free.cassandra.config.MyRetryPolicy".some,
    speculativeExecutionPolicy = "freestyle.free.cassandra.config.MySpeculativeExecutionPolicy".some,
    sslOptions = "freestyle.free.cassandra.config.MySSLOptions".some,
    threadingOptions = "freestyle.free.cassandra.config.MyThreadingOptions".some,
    timestampGenerator = "freestyle.free.cassandra.config.MyTimestampGenerator".some,
    ...
    poolingOptionsConfig = PoolingOptionsConfig(
      ...
      initializationExecutor = "freestyle.free.cassandra.config.MyJavaExecutor".some
    ).some,
