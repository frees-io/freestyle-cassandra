  ...
  object MetaMacroInterpolator {
    ...
    private[this] def companion(typeName: Type.Name, path: String, validator: ValidatorType) =
      q"""object ${Term.Name(typeName.value)} {
          ...
          import _root_.freestyle.free.cassandra.codecs.ByteBufferCodec
          import _root_.freestyle.free.cassandra.query.interpolator.{CQLInterpolator, CQLLiteral}
          import _root_.freestyle.free.cassandra.query.model.SerializableValue
          import _root_.freestyle.free.cassandra.schema.provider._
          import _root_.freestyle.free.cassandra.schema.validator._
